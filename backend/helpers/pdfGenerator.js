...
function generarNombreArchivo(tipo, inputData) {
    ...
    // Obtener nombre y limpiar tildes, caracteres especiales y espacios por guiones bajos
    ...
    // Obtener la fecha del día de creación (YYYY-MM-DD)
...
async function generarActaPDF(inputData = {}) {
    ...
    if (tipoActa.includes('asignacion')) {
        return await generarActaAsignacion(inputData);
    } else {
        return await generarActaDevolucion(inputData);
    }
}
 ...
 */
async function generarActaDevolucion(inputData = {}) {
    const data = {
        ...
        fechaDevolucion: inputData.fechaDevolucion || inputData.fecha || inputData.fechaAsignacion || '',
            ...
            <td>
                <table class="header-table">
                    <tr>
                        ...
                        <td class="meta-cell">Fecha: ${data.fechaDevolucion || '&nbsp;'}</td>
                    </tr>
                    <tr>
    ...
    <tbody>
        <tr>
            <td>
                ...
                <p class="MsoNormal" style="margin-left:16.9pt; margin-top:8px; margin-bottom:14px; text-align:justify;"><span lang="ES" style="font-size:12.0pt;">ASUNTO: <b style="mso-bidi-font-weight:normal"><span style="letter-spacing:-.1pt">DEVOLUCIÓN</span></b></span></p>
                ...
                <table class="TableNormal" border="1" cellspacing="0" cellpadding="0" style="margin-left:28.25pt; border:none; mso-border-alt:solid black 2.0pt; mso-border-insideh:2.0pt solid black; mso-border-insidev:2.0pt solid black">
                 ...
                 <tr style="height:14.95pt">
                  ...
                  <td width="451" valign="top" style="width:338.1pt;border:solid black 2.0pt;border-top:none;border-left:none;padding:3px 6px;">
                  <p class="TableParagraph"><span lang="ES">${data.fechaDevolucion || '&nbsp;'}</span></p>
                  </td>
                 </tr>
                </tbody></table>
...
/**
 * Generador del Acta de Asignación con el contenido proporcionado
 */
async function generarActaAsignacion(inputData = {}) {
    const data = {
        nombresCompletos: inputData.nombresColaborador || inputData.nombresCompletos || inputData.nombre || inputData.nombreCompleto || inputData.colaborador || '',
        identificacion: inputData.identificacion || inputData.cedula || inputData.documento || '',
        correoCorporativo: inputData.correoCorporativo || inputData.correo || inputData.email || '',
...
<table class="master-table">
    ...
    <tbody>
        <tr>
            <td>
                <p class="MsoBodyText" style="margin-left:19.7pt; margin-bottom:14px; text-align:justify;"><span lang="ES">Positivos<span style="letter-spacing:-.35pt"> </span><span style="letter-spacing:-.5pt">+</span></span></p>
                <p class="MsoNormal" style="margin-left:16.9pt; margin-top:8px; margin-bottom:14px; text-align:justify;"><span lang="ES" style="font-size:12.0pt;">ASUNTO: <b style="mso-bidi-font-weight:normal"><span style="letter-spacing:-.1pt">ASIGNACIÓN</span></b></span></p>
